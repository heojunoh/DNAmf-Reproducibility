...
-   Section 4: Figure 3
-   Section 5: Figure 4, 5, S9, S10, and S11
-   Section 6: Figure 7 and S12
-   Section 7: Figure 8
...
##### Reproducing Figure 5, S9, S10, and S11
...
This reproduces the boxplot results for Supplementary Materials with T = 4/3 and gamma = 2.
...
<img src="figure/Figure S9.png" style="display: block; margin: auto;"/>

This reproduces the boxplot results for Supplementary Materials with T = 3/2 and gamma = 1.
...
<img src="figure/Figure S10.png" style="display: block; margin: auto;"/>

This reproduces the boxplot results for Supplementary Materials with T = 2 and gamma = 1.
...
<img src="figure/Figure S11.png" style="display: block; margin: auto;"/>
...
##### Reproducing Figure S12

This reproduces the illustrations of Poisson's equation (top row) and the heat equation (bottom row).

``` r
# Run code
source("Real Applications Figure S12.R")
figureS12
```

<img src="figure/Figure S12.png" style="display: block; margin: auto;"/>
